...
const Leaderboard = () => {
    ...
    // Fetching data for leaderboard with users and results
    ...
    // Fetching data to find other user result
    ...
    return (
        <div style={{height:'100vh', padding: '80px 200px', backgroundColor: '#BFAFF2', display: "flex", flexDirection: "column", backgroundImage: loader ? 'inherit' : `url(${process.env.PUBLIC_URL + 'img/groupmain.svg'})`, backgroundRepeat: 'no-repeat', backgroundPosition: 'center', backgroundSize: 'cover' }}>
            {loader ?
                (<div style={{ margin: 'auto', display: "flex", flexDirection: "column", padding: '200px' }}>
                    ...
                    /></div>) : (<div style={{ display: "flex", flexDirection: "column" }}>
                        <h1 style={{ margin: 'auto', borderBottom: '5px dotted #F8D57E', color: 'rgba(255, 255, 255, 1)', marginBottom: '30px' }}>Leaderboard</h1>
